...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  19, PIO_DIGITAL, PIN_ATTR_PWM_F, No_ADC_Channel, TCC1_CH3, TC3_CH1, EXTERNAL_INT_3 }, // D3
  { PORTA,  20, PIO_DIGITAL, PIN_ATTR_PWM_G, No_ADC_Channel, TCC0_CH0, NOT_ON_TIMER, EXTERNAL_INT_4 }, // D4
  { PORTA,  21, PIO_DIGITAL, PIN_ATTR_PWM_G, No_ADC_Channel, TCC0_CH1, NOT_ON_TIMER, EXTERNAL_INT_5 }, // D5
  { PORTB,   2, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel14, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2 }, // Dotstar Clock
  { PORTA,   0, PIO_DIGITAL, PIN_ATTR_PWM_E, No_ADC_Channel,  TC2_CH0, TC2_CH0, EXTERNAL_INT_0 }, //for Button_Builtin

  // 8
  // Digital High
  { PORTB,   3, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel15, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 }, // Dotstar Data

  // 9 (LED)
  { PORTA,  15, PIO_DIGITAL, PIN_ATTR_PWM_G, No_ADC_Channel, TCC0_CH2, NOT_ON_TIMER, EXTERNAL_INT_6 }, // D14
  ...
  { PORTA,  6, PIO_ANALOG, (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E), ADC_Channel6, TC1_CH0, TC1_CH0, EXTERNAL_INT_6 }, // A5

  // 17 Extra Analog pin #20
  ...
  { PORTB, 22, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6 }, // MOSI SERCOM 1.2
  ...
  // ----------------------
  // 27 - 29 Alternate use of A0 and A1 (DAC output)
  ...
  // ----------------------
  // 30 - 35 QSPI (SCK, CS, IO0, IO1, IO2, IO3)
